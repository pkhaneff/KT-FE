...
export function listAdminUsers(accessToken) {
  return adminRequest('/admin/users', accessToken, { method: 'GET' })
}

export function updateAdminUser(accessToken, userId, payload) {
  return adminRequest(`/admin/users/${userId}`, accessToken, {
    method: 'PATCH',
