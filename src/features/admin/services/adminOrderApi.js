...
export function adminListOrders(accessToken) {
  return apiRequest('/admin/orders', accessToken, {
    method: 'GET',
  })
}

export function adminUpdateOrderStatus(accessToken, orderId, status) {
  return apiRequest(`/admin/orders/${orderId}/status`, accessToken, {
    method: 'PATCH',
