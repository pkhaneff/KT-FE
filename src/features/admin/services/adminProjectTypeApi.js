...
export function adminListProjectTypes(accessToken) {
  return apiRequest('/admin/project-types', accessToken, {
    method: 'GET',
  })
}

export function adminCreateProjectType(accessToken, payload) {
  return apiRequest('/admin/project-types', accessToken, {
    method: 'POST',
...
export function adminUpdateProjectType(accessToken, projectTypeId, payload) {
  return apiRequest(`/admin/project-types/${projectTypeId}`, accessToken, {
    method: 'PATCH',
    body: JSON.stringify(payload),
  })
}
